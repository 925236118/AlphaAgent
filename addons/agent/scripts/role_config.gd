...
class RoleManager:
	...
	func add_default_roles():
		...
		default_role.prompt = ""
		default_role.tools = AlphaAgentPlugin.instance.main_panel.tools.get_function_name_list().keys()
		...
		readonly_role.tools = AlphaAgentPlugin.instance.main_panel.tools.get_function_name_list().keys().filter(func(key): return AlphaAgentPlugin.instance.main_panel.tools.get_function_name_list()[key].readonly)
		...
		workflow_role.tools = AlphaAgentPlugin.instance.main_panel.tools.get_function_name_list().keys()
